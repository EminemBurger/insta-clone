            ...
            <div className="flex justify-between max-w-6xl mx-5 xl:mx-auto">
                ...
                <div className="max-w-xs">
                    <div className="relative mt-1 p-3 rounded-md">
                        ...
                        <input className="bg-gray-50 block w-full pl-10 border-gray-300
                        sn:text-sm focus:ring-black focus:border-black rounded-md" type="text" placeholder="Search"></input>
                    </div>
                </div>
